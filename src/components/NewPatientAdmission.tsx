...
import { UserPlus, Calendar, Clock, User, Users, Activity, FileText } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">New Patient Admission</h1>
